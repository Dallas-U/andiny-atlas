            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-400">
                        Your latest investigation activity.
                    </p>
                </div>
                ...
                investigations.length === 0 && (
                    <div className="mt-4">
                        <EmptyState
                            ...
                            description="Start your first investigation using the Quick Actions above. Recent investigations will appear here automatically."
                            icon={
